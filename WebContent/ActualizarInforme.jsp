                ...
                <div class="shadow-lg p-3 mb-5 mt-4 bg-body rounded">                                    
                    ...
                    <form class="row g-3 needs-validation" novalidate action="informe">
                        <div class="col-md-6 position-relative">
                            ...
                            <label for="apellido" class="form-label">Codigo del Informe</label>
                            <input type="text" class="form-control" id="apellido" name="txtIdInforme" required  value="${p.idReporteInformacion}">
                        ...
                        <%-- 
                        <div class="col-md-6 position-relative">
                            <label for="pais" class="form-label">Usuario</label>
                            <select class="form-select" id="cboOrganismo" required name="txtUsuario">
                                <option selected disabled value="">Seleccione...</option>
                        ...
                        <div class="col-md-6 position-relative">
                            <label for="pais" class="form-label">Usuario</label>
                            <select class="form-select" id="cboOrganismo" required name="txtEstado">
                                <option selected disabled value="">Seleccione...</option>
                                
                                <option selected  value="Registrado">Registrado</option>
                                
                                <<c:if test="${u.idCargo==2 || u.idCargo==3}">
                                <option selected  value="Pre-Aprobado">Pre-Aprobado</option>
                                </c:if>
                               
                               <<c:if test="${u.idCargo==3 }">
                        ...
                        <div class="col-md-6 position-relative">
                            <label for="apellido" class="form-label">Nombre del Responsable</label>
                            <input type="text" class="form-control" id="apellido" required name="txtUsuario"  value="${u.idCargo}">
                            <!-- Mensajes para validación   -->
                            <div class="valid-tooltip">¡Campo válido!</div>
                            <div class="invalid-tooltip">Debe completar los datos.</div>
                        </div>
						...
						<div class="col-12">
						<button class="btn btn-danger fw-bold float" type="submit" name="opcion" value="a">Actualizar</button>

                        <button class="btn btn-secondary fw-bold float"  name="opcion" value="l">Volver</button>
                        </div>
                    </form>
                    ${mensaje }
                </div>
